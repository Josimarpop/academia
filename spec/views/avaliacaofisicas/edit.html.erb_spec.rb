...
describe "avaliacaofisicas/edit" do
  before(:each) do
  ...
  it "renders the edit avaliacaofisica form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", avaliacaofisica_path(@avaliacaofisica), "post" do
