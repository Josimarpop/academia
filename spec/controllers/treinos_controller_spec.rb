...
describe TreinosController do
  ...
  let(:valid_attributes) { { "serie" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved treino as @treino" do
        ...
        post :create, {:treino => { "serie" => "invalid value" }}, valid_session
        assigns(:treino).should be_a_new(Treino)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested treino" do
        ...
        Treino.any_instance.should_receive(:update).with({ "serie" => "MyString" })
        put :update, {:id => treino.to_param, :treino => { "serie" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the treino as @treino" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Treino.any_instance.stub(:save).and_return(false)
        put :update, {:id => treino.to_param, :treino => { "serie" => "invalid value" }}, valid_session
        assigns(:treino).should eq(treino)
      end
